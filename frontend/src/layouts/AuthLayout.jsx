  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#f8fafc]">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10 border border-gray-100 relative">
          ...
          <div className="flex flex-col items-center justify-center mb-8 lg:hidden">
            ...
            <h1 className="text-3xl font-bold text-gray-800 tracking-tight">EcoSphere</h1>

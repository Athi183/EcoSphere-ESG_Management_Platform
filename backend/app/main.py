...
from app.routers import auth, departments, categories, emission_factors, carbon_transactions, dashboard, ai, policies, csr_activities, challenges, gamification, reports

...
- Category: Shared category values used across Social and Gamification modules (e.g., CSR Activity Category, Challenge Category) (Name, Type, Status)
...
│
▼
Overall ESG Score (weighted average of Department Total Scores - default weighting: Environmental 40% / Social 30% / Governance 30%, configurable per organization)
│
▼
